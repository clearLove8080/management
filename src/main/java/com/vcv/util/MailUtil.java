...
public class MailUtil {
	 //发件人地址
    public static String senderAddress = "vculturev@163.com";
    //收件人地址
    public static String recipientAddress = "597213343@qq.com";
    //发件人账户名
    public static String senderAccount = "vculturev@163.com";
    //发件人账户密码
    public static String senderPassword = "Qq597213343";
    ...
    public static void sendTextMail(String	recipientAddress,String checkUrl) {
		...
		try {
			msg = getTextMimeMessage(session,recipientAddress,checkUrl);
     ...
     */
    public static MimeMessage getTextMimeMessage(Session session,String	recipientAddress,String checkUrl) throws Exception{
        //创建一封邮件的实例对象
    ...
    public static void sendMailPic() {
    	//1、连接邮件服务器的参数配置
        Properties props = new Properties();
        //设置用户的认证方式
        props.setProperty("mail.smtp.auth", "true");
